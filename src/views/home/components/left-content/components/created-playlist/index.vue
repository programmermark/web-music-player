  ...
  <div class="created-playlist">
    ...
    <div class="all-playlist" v-show="hasCollapsed">
      <div class="liked-playlist">
        <div class="content-left" @click="handlePlayListClick(likedPlayList.id)">
          <MPIcon icon="heart" color="#494949" :size="16" :scale="1" bgColor="none" />
      ...
      <div class="playlist" v-for="playlist in otherPlayLists" :key="playlist.id">
...
const otherPlayLists = computed(() => {
  return playlists.value.filter((_playlist, index) => index !== 0);
});
